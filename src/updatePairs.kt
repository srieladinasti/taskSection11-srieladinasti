fun main() {
    ...
    println(volumeBalok)
    volumeBalok.put("Panjang Balok", 18)
    println(volumeBalok)
    ...
    println(luasPP)
    luasPP.put("Panjang Persegi Panjang", 9)
    println(luasPP)
    ...
    volumeTabung.put("Tinggi Tabung", 15)
    println(volumeTabung)
    ...
    println(luasSegitiga)
    luasSegitiga.put("Alas Segitiga", 15)
    println(luasSegitiga)
    ...
    println(luasJG)
    luasJG.put("Tinggi Jajar Genjang", 15)
    println(luasJG)
}